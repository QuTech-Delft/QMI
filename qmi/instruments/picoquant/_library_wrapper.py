...
from qmi.instruments.picoquant._mhlib_function_signatures import _mhlib_function_signatures
from qmi.instruments.picoquant._phlib_function_signatures import _phlib_function_signatures
from qmi.instruments.picoquant._th260lib_function_signatures import _th260lib_function_signatures
...
class _LibWrapper:
    ...
    def __init__(self, model: str) -> None:
        ...
        if sys.platform.startswith("linux"):
            if model == "TH260":
                self._lib = ctypes.cdll.LoadLibrary("libth260.so")
                self.annotate_function_signatures(_th260lib_function_signatures)
            ...
            if model == "HH":
                ...
                try:
                    self._lib = ctypes.WinDLL("th260lib64.dll")  # 64-bit version
                except:
                    self._lib = ctypes.WinDLL("th260lib.dll")  # 32-bit version
