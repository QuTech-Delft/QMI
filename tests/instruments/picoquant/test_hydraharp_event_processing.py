...
class TestHydraHarpEventFilter(unittest.TestCase):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.events_in_resolution_1 = self.gen_random_events(
            num_events=1000,
            event_rate=2.0e6,
    ...
    def test_simple(self):
        ...
        fifo_words_in = self.events_to_fifo(events_in, sync_period, 1.0)  # resolution = 1
    ...
    def test_simple_clip_resolution(self):
        ...
        # Patch the readFifo() function.
        fifo_words_in = self.events_to_fifo(events_in, sync_period, resolution.value)  # resolution = 1
        done_event = threading.Event()
        self._library_mock.ReadFiFo.side_effect = self.make_patched_read_fifo(fifo_words_in, done_event)
    ...
    def test_aperture_filter_events(self):
        ...
        event_rate = 2.0e9
        # Generate a random set of events.
        events_in = self.gen_random_events(
