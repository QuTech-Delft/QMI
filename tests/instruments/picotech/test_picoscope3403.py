...
from qmi.instruments.picotech import picoscope3403
...
class PicoscopeMethodsTestCase(unittest.TestCase):
    ...
    def setUp(self) -> None:
        ...
        self._picoscope._ps = PropertyMock(autospec=True)
    ...
    def test_acquire_by_trigger_and_get_data_ok_interval_1_2_4ns(self):
        """Test that the acquire_by_trigger_and_get_data returns data with correct settings
        ...
        for i in range(3):
            time_span = sampling_intervals[i] * samples  # ns
    ...
    def test_acquire_by_trigger_and_get_data_ok_interval_8ns(self):
    ...
    def test_acquire_by_trigger_and_get_data_nok_incorrect_channels_to_timebase(self):
        """Test trying to acquire data with invalid number of channels to time-bases 0 and 1."""
        channels = [[0, 1], [1, 2, 3]]
        sampling_intervals = [1, 2]  # For time-bases 0 and 1
        for i in range(2):
    ...
    def test_acquire_by_trigger_and_get_data_nok_incorrect_sampling_intervals(self):
        """Test trying to acquire data with invalid sampling_interval values."""
        sampling_intervals = [0, 3, 7, 15, 19, 13235]
