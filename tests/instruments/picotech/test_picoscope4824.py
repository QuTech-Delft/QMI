...
from qmi.instruments.picotech import picoscope4824, ChannelCoupling, TriggerEdge, _picoscope
...
class PicoscopeMethodsTestCase(unittest.TestCase):
    ...
    def setUp(self) -> None:
        ...
        qmi.start('test_picoscope_4824')
        self._picoscope = qmi.make_instrument('PicoScope', picoscope4824.PicoTech_PicoScope4824, "GR956/0069")
        # Mock the PicoScope "open" function to be able to open the virtual unit.
        self._picoscope._ps_attr = Mock(spec=ps4000a)
